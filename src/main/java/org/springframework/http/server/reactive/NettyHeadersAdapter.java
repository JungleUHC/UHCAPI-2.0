...
/* 237 */       return new NettyHeadersAdapter.HeaderNamesIterator(NettyHeadersAdapter.this.headers.names().iterator());
/*     */     }
/*     */ 
/*     */     
/*     */     public int size() {
/* 242 */       return NettyHeadersAdapter.this.headers.names().size();
/*     */     }
/*     */   }
/*     */   
...
/* 254 */       this.iterator = iterator;
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean hasNext() {
/* 259 */       return this.iterator.hasNext();
/*     */     }
/*     */ 
/*     */     
/*     */     public String next() {
/* 264 */       this.currentName = this.iterator.next();
/* 265 */       return this.currentName;
/*     */     }
/*     */ 
/*     */     
/*     */     public void remove() {
/* 270 */       if (this.currentName == null) {
/* 271 */         throw new IllegalStateException("No current Header in iterator");
/*     */       }
/* 273 */       if (!NettyHeadersAdapter.this.headers.contains(this.currentName)) {
/* 274 */         throw new IllegalStateException("Header not present: " + this.currentName);
/*     */       }
/* 276 */       NettyHeadersAdapter.this.headers.remove(this.currentName);
/*     */     }
/*     */   }
/*     */ }


/* Location:              /home/altaks/Téléchargements/mumblelink-1.0-SNAPSHOT.jar!/org/springframework/http/server/reactive/NettyHeadersAdapter.class
