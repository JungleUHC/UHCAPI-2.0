...
/*  94 */     String method = connection.getRequestMethod();
/*  95 */     if ((method.equals("PUT") || method.equals("DELETE")) && 
/*  96 */       !StringUtils.hasText(headers.getFirst("Accept")))
/*     */     {
/*     */       
/*  99 */       headers.set("Accept", "*/*");
/*     */     }
/*     */     
/* 102 */     headers.forEach((headerName, headerValues) -> {
...
/* Location:              /home/altaks/Téléchargements/mumblelink-1.0-SNAPSHOT.jar!/org/springframework/http/client/SimpleBufferingClientHttpRequest.class
