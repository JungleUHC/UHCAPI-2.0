...
/*  70 */     sb.append(this.pattern).append('\n');
/*  71 */     for (int i = 0; i < this.position; i++) {
/*  72 */       sb.append(' ');
/*     */     }
/*  74 */     sb.append("^\n");
/*  75 */     sb.append(getMessage());
...
/* 103 */     NO_MORE_DATA_EXPECTED_AFTER_CAPTURE_THE_REST("No more pattern data allowed after '{*...}' or '**' pattern element"),
...
/* Location:              /home/altaks/Téléchargements/mumblelink-1.0-SNAPSHOT.jar!/org/springframework/web/util/pattern/PatternParseException.class
