...
public interface BeanFactory {
  ...
  @Nullable
  Class<?> getType(String paramString, boolean paramBoolean) throws NoSuchBeanDefinitionException;
  
  String[] getAliases(String paramString);
}


/* Location:              /home/altaks/Téléchargements/mumblelink-1.0-SNAPSHOT.jar!/org/springframework/beans/factory/BeanFactory.class
