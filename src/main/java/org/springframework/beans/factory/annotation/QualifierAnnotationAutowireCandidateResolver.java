...
/*     */ 
/*     */             
/* 190 */             if ((fallbackToMeta && ObjectUtils.isEmpty(AnnotationUtils.getValue(metaAnn))) || 
...
/* 302 */     AnnotatedElement qualifiedElement = bd.getQualifiedElement();
/* 303 */     return (qualifiedElement != null) ? AnnotationUtils.getAnnotation(qualifiedElement, type) : null;
/*     */   }
/*     */   
/*     */   @Nullable
/*     */   protected Annotation getFactoryMethodAnnotation(RootBeanDefinition bd, Class<? extends Annotation> type) {
/* 308 */     Method resolvedFactoryMethod = bd.getResolvedFactoryMethod();
/* 309 */     return (resolvedFactoryMethod != null) ? AnnotationUtils.getAnnotation(resolvedFactoryMethod, type) : null;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 320 */     if (!super.isRequired(descriptor)) {
/* 321 */       return false;
/*     */     }
/* 323 */     Autowired autowired = (Autowired)descriptor.getAnnotation(Autowired.class);
/* 324 */     return (autowired == null || autowired.required());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 334 */     for (Annotation ann : descriptor.getAnnotations()) {
/* 335 */       if (isQualifier(ann.annotationType())) {
/* 336 */         return true;
/*     */       }
/*     */     } 
/* 339 */     return false;
...
/* 349 */     Object value = findValue(descriptor.getAnnotations());
/* 350 */     if (value == null) {
/* 351 */       MethodParameter methodParam = descriptor.getMethodParameter();
/* 352 */       if (methodParam != null) {
/* 353 */         value = findValue(methodParam.getMethodAnnotations());
/*     */       }
/*     */     } 
/* 356 */     return value;
/*     */   }
...
/* 364 */     if (annotationsToSearch.length > 0) {
/* 365 */       AnnotationAttributes attr = AnnotatedElementUtils.getMergedAnnotationAttributes(
/* 366 */           AnnotatedElementUtils.forAnnotations(annotationsToSearch), this.valueAnnotationType);
/* 367 */       if (attr != null) {
/* 368 */         return extractValue(attr);
/*     */       }
/*     */     } 
/* 371 */     return null;
/*     */   }
...
/* 379 */     Object value = attr.get("value");
/* 380 */     if (value == null) {
/* 381 */       throw new IllegalStateException("Value annotation must have a value attribute");
/*     */     }
/* 383 */     return value;
/*     */   }
/*     */ }
...
/* Location:              /home/altaks/Téléchargements/mumblelink-1.0-SNAPSHOT.jar!/org/springframework/beans/factory/annotation/QualifierAnnotationAutowireCandidateResolver.class
