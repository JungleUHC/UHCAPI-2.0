...
/* 638 */         return -1;
/*     */       }
/* 640 */       if (!mimeType1.getType().equals(mimeType2.getType())) {
/* 641 */         return 0;
/*     */       }
/*     */       
/* 644 */       if (mimeType1.isWildcardSubtype() && !mimeType2.isWildcardSubtype()) {
/* 645 */         return 1;
/*     */       }
/* 647 */       if (mimeType2.isWildcardSubtype() && !mimeType1.isWildcardSubtype()) {
/* 648 */         return -1;
/*     */       }
/* 650 */       if (!mimeType1.getSubtype().equals(mimeType2.getSubtype())) {
/* 651 */         return 0;
/*     */       }
/*     */       
/* 654 */       return compareParameters(mimeType1, mimeType2);
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     protected int compareParameters(T mimeType1, T mimeType2) {
/* 660 */       int paramsSize1 = mimeType1.getParameters().size();
/* 661 */       int paramsSize2 = mimeType2.getParameters().size();
/* 662 */       return Integer.compare(paramsSize2, paramsSize1);
/*     */     }
/*     */   }
/*     */ }


/* Location:              /home/altaks/Téléchargements/mumblelink-1.0-SNAPSHOT.jar!/org/springframework/util/MimeType.class
